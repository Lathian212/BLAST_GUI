...
class Blastn:
    ...
    def buildBlock1(self):
        ...
        R2 = tk.Radiobutton(self.inFrm, text="blastn", font=('Arial', '12'), variable=blastRadio, value=2, command=self.blastSwitch)
        R2.grid(row = self.ROW, column = 2)
        R3 = tk.Radiobutton(self.inFrm, text="blastn", font=('Arial', '12'), variable=blastRadio, value=3, command=self.blastSwitch)
        R3.grid(row = self.ROW, column = 3)
        R4 = tk.Radiobutton(self.inFrm, text="blastn", font=('Arial', '12'), variable=blastRadio, value=4, command=self.blastSwitch)
        R4.grid(row = self.ROW, column = 4)
        R5 = tk.Radiobutton(self.inFrm, text="blastn", font=('Arial', '12'), variable=blastRadio, value=5, command=self.blastSwitch)
